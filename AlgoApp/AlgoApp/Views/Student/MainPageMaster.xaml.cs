        ...
        class MainPageMasterViewModel : BaseListViewModel<MasterMenuItemModel>
        {
            ...
            public MainPageMasterViewModel(MasterDetailPage master)
            {
                ...
                Items = new ObservableCollection<MasterMenuItemModel>(new[]
                {
                    ...
                    new MasterMenuItemModel { Id = 6, Title = "做题记录", Action = () => master.Detail = new NavigationPage(new ChapterListPage(pageType: ChapterListPage.PageType.AnswerHistory, App.UserId) { Title = "做题记录" }) },
                    new MasterMenuItemModel { Id = 7, Title = "排行榜", Action = () => master.Detail = new NavigationPage(new RankingTabbedPage()) },
                    new MasterMenuItemModel { Id = 8, Title = "退出", Action = () => {
                        appServer.Logout();
